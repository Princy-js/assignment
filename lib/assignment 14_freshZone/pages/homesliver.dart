...
import '../refactoring pages/box1_refactor.dart';
import '../refactoring pages/box2_refactor.dart';
import '../refactoring pages/box3_refactor.dart';
                        ...
                        children: [
                          Column(
                            children: [
                              Image(
                                image: AssetImage(
                                    'assets/farmersFZ/vanicontwo.png'),
                              ),
                              Padding(
                                padding:
                          ...
                          Column(
                            children: [
                              Image(
                                image: AssetImage(
                                    'assets/farmersFZ/traceability.png'),
                                width: 30,
                                height: 30,
                              ),
                              Padding(
                            ...
                            CarouselSlider(
                                items: [
                                  Box4(
                                      ...
                                      text3:
                                          'Being a customer of Farmers Fresh Zone, I can definitely'
                                  ...
                                  Box4(
                                      ...
                                      text2: 'Alosisous',
                                      text3:
                                          'As concerned parents. we wanted our kids to eat pesticide'
                                          '-free & healthy food and that'
                                          's how we came across Farmers '
                                  ...
                                  Box4(
                                      ...
                                      text3: 'I tried Farmers Fresh Zone'
                                          's products for the first'
